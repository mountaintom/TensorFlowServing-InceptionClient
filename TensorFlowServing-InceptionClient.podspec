...
Pod::Spec.new do |s|
  ...
  s.subspec "InceptionClient" do |cs|
    ...
    cs.xcconfig = { 'USER_HEADER_SEARCH_PATHS' => '"./TensorFlowServing-InceptionClient/TensorFlowServing-InceptionClient/Classes/third_party" "../../TensorFlowServing-InceptionClient/Classes/third_party" "./" "./third_party/" "${PROJECT_DIR}/../TensorFlowServing-InceptionClient/Classes/third_party"',
                 'HEADER_SEARCH_PATHS' => '"./TensorFlowServing-InceptionClient/TensorFlowServing-InceptionClient/Classes/third_party" "../../TensorFlowServing-InceptionClient/Classes/third_party" "./" "./third_party/" "${PROJECT_DIR}/../TensorFlowServing-InceptionClient/Classes/third_party"' }
  ...
  s.xcconfig = { 'USER_HEADER_SEARCH_PATHS' => '"./TensorFlowServing-InceptionClient/TensorFlowServing-InceptionClient/Classes/third_party" "../../TensorFlowServing-InceptionClient/Classes/third_party" "./" "./third_party/" "${PROJECT_DIR}/../TensorFlowServing-InceptionClient/Classes/third_party"',
                 'HEADER_SEARCH_PATHS' => '"./TensorFlowServing-InceptionClient/TensorFlowServing-InceptionClient/Classes/third_party" "../../TensorFlowServing-InceptionClient/Classes/third_party" "./" "./third_party/" "${PROJECT_DIR}/../TensorFlowServing-InceptionClient/Classes/third_party"' }
